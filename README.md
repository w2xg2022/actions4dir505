...
2. 解决思路是将无线AP和共享打印的功能拆开由二台机器分别来完成，选中了D-Link DIR-505这款2012年发售的迷你路由器，三围约68×42×51mm，CPU是Atheros AR9330 rev 1，属于MIPS 24Kc V7.4架构，无线150M、有线100M，Coremark跑分966。比较重要的是放在现在都不算太弱的8M闪存+64M内存，而且自带uboot，大大提升了固件编译和刷机的便利性。
